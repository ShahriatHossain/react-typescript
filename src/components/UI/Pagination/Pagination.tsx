                            ...
                            <div className="pagination">
                                {pages.map((page, index) => {
                                    ...
                                    if (page === LEFT_PAGE) return (
                                        <a key={index} href="#" onClick={this.handleMoveLeft}>Prev</a>
                                    );

                                    if (page === RIGHT_PAGE) return (
                                        <a key={index} href="#" onClick={this.handleMoveRight}>Next</a>
                                    );

                                    return (
                                        <a key={index} href="#" className={currentPage === page ? ' active' : ''} onClick={this.handleClick(page)}>{page}</a>
                                    );
